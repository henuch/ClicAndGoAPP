...
//		System.out.println();
	...
	public void afficheCheminByStation(String depart,String arrivee){
	   Station stationdepart=StationDelegate.findStationByStationName(depart);
	   Station stationarrivee=StationDelegate.findStationByStationName(arrivee);
		...
		System.out.println(" de "+stationdepart.getName()+" à "+ stationarrivee.getName()+":");
		...
		Station stationvariable = StationDelegate.doFindStationByReference(lesNoeudsIntermediaires.get(j));
	...
	public void AfficherDestinationEtCout(String depart,String arrivee)
	{ // Station stationdepart=StationDelegate.findStationByStationName(depart);
	   Station stationarrivee=StationDelegate.findStationByStationName(arrivee);
	...
	public static void main(String[] args) {
		...
		Station stationdepart=StationDelegate.findStationByStationName("Ariana");
		//Station stationarrivee=StationDelegate.findStationByStationName("La marsa");
		...
		Dijkstra beaulieuAutresStations= new Dijkstra(stationdepart.getReference(),g0);
...
//		System.out.println("Le temps mini pour aller de beaulieu à VilleJean est :"+dureeVillejean);
		...
		//beaulieuAutresStations.afficheCheminByStation(barcelone); // pour ça il faut un tableau de prédécesseur, il nous faudra un tableau de routage
