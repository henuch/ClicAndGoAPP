...
public class Dijkstra {
	...
	private static int dimensionDeLaMatrice;// je rajoute ça pour simplifier le
											// code.
	...
	public static void main(String[] args) {
		...
		// Clemenceau
		// beaulieuAutresStations.afficheCheminByStation(barcelone); // pour ça
		// il faut un tableau de prédécesseur, il nous faudra un tableau de
		// routage
		// il nous faudrait créer un tableau R des prédecesseurs.

		beaulieuAutresStations.AfficherDestinationEtCout("Ariana", "La marsa");
		// Creation d'une nouvelle instance de l'algorithme avec un départ de
		// Republique
